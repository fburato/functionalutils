...
class TypeSafeChainComparatorTest {
    ...
    void testImmutable() {
        ...
        final var comparator1 = TypeSafeChainComparator
                .create(TestData.class)
                .chain(TestData::getA, String::compareTo);
    ...
    class CreateTest {
        ...
        final TypeSafeChainComparator<TestData> testee = TypeSafeChainComparator.create(TestData.class)
                .chain(TestData::getA, String::compareTo)
                .chain(TestData::getA1, String::compareTo)
                .chain(TestData::getB, Integer::compareTo)
                .chain(TestData::getC, Double::compareTo);

        @Test
        @DisplayName("should compare elements in order of chain invocations")
        void testOrder() {
            assertThat(testee.compare(
                    new TestData("1", null, 345, 234),
                    new TestData("2", null, 0, 432))).isLessThan(0);
            assertThat(testee.compare(
                    new TestData("1", "1", 0, 23423.0),
                    new TestData("1", "2", 0, 0.0))).isLessThan(0);
            assertThat(testee.compare(
                    new TestData("1", "1", 1, 0.0),
                    new TestData("1", "1", 0, 23423.0))).isGreaterThan(0);
            assertThat(testee.compare(
                    new TestData("1", "1", 1, 0.0),
                    new TestData("1", "1", 1, 1.0))).isLessThan(0);
            assertThat(testee.compare(
                    new TestData("1", "1", 1, 1.0),
                    new TestData("1", "1", 1, 1.0))).isEqualTo(0);
        }
    }
    ...
    class TestNullSafe {
        ...
        final TypeSafeChainComparator<TestData> testee = TypeSafeChainComparator.createNullSafe(TestData.class)
                .chain(TestData::getA, stringLengthComparator)
                .chain(TestData::getA1, stringLengthComparator)
        ...
        void testOrder() {
            assertThat(testee.compare(
                    new TestData("1", null, 345, 234),
                    new TestData("11", null, 0, 432)))
                            .isLessThan(0);
            assertThat(testee.compare(
                    new TestData("1", "1", 0, 23423.0),
                    new TestData("1", "11", 0, 0.0)))
                            .isLessThan(0);
            assertThat(testee.compare(
                    new TestData("1", "1", 10, 0.0),
                    new TestData("1", "1", 0, 23423.0)))
                            .isGreaterThan(0);
            assertThat(testee.compare(
                    new TestData("1", "1", 1, 0.0),
                    new TestData("1", "1", 1, 10.0))).isLessThan(0);
            assertThat(testee.compare(
                    new TestData("1", "1", 1, 1.0),
                    new TestData("1", "1", 1, 1.0))).isEqualTo(0);
        }
        ...
        void testNullSafety() {
            assertThat(testee.compare(
                    new TestData(null, null, 345, 234),
                    new TestData("11", null, 0, 432)))
                            .isLessThan(0);
            assertThat(testee.compare(
                    new TestData(null, "1", 0, 23423.0),
                    new TestData(null, "11", 0, 0.0)))
                            .isLessThan(0);
            assertThat(testee.compare(
                    new TestData(null, null, 10, 0.0),
                    new TestData(null, null, 0, 23423.0)))
                            .isGreaterThan(0);
            assertThat(testee.compare(
                    new TestData(null, null, 1, 0.0),
                    new TestData(null, null, 1, 10.0)))
                            .isLessThan(0);
            assertThat(testee.compare(
                    new TestData(null, null, 1, 1.0),
                    new TestData(null, null, 1, 1.0))).isEqualTo(0);
        }
    }
    ...
    class AddComparatorTest {
        ...
        void testSameComparator() {
            assertThat(testee.compare(
                    new TestData("111", "1", 345, 234),
                    new TestData("11", "11", 0, 432)))
                            .isLessThan(0);
            assertThat(testee.compare(
                    new TestData("", "111", 0, 23423.0),
                    new TestData("a", "11", 0, 0.0)))
                            .isGreaterThan(0);
            assertThat(testee.compare(
                    new TestData("", "1", 10, 0.0),
                    new TestData(null, null, 0, 23423.0)))
                            .isGreaterThan(0);
            assertThat(testee.compare(
                    new TestData("", null, 100, 0.0),
                    new TestData("", null, 1, 10.0))).isLessThan(0);
            assertThat(testee.compare(
                    new TestData(null, null, 1, 1.0),
                    new TestData(null, null, 1, 1.0))).isEqualTo(0);
        }
